package Hw1_21000709_HoangTuanTu.exercise06.project231;
...
public class Ecosystem {
    ...
    public void check() {
        ...
        for (int i = 0; i < river.size() - 1; i++) {
            ...
            for (Animal animal2 : ySet.subSet(lowerBound, true, upperBound, true)) {
                if (animal1.distance(animal2) <= animal1.getRange()) {
    ...
    private void clean() {
        ...
        for (Animal[] closestPair : closestPairs) {
            closestPair[0].collide(closestPair[1]);
        }
    }
